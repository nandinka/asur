...
public class DAOFactory {
    ...
    public PerfilDAO getPerfilDAO() {
        return new PerfilDAOImpl(conn);
    }

    public FuncionalidadDAO getFuncionalidadDAO() {
        return new FuncionalidadDAOImpl(conn);
    }

    public AuditoriaDAO getAuditoriaDAO() {
        return new AuditoriaDAOImpl(conn);
    }

    public TelefonoDAO getTelefonoDAO() {
        return new TelefonoDAOImpl(conn);
    }

    public RecursoDAO getRecursoDAO() {
        return new RecursoDAOImpl(conn);
    }

    public ReservaDAO getReservaDAO() {
        return new ReservaDAOImpl(conn);
    }

    public TipoActividadDAO getTipoActividadDAO() {
        return new TipoActividadDAOImpl(conn);
    }
    ...
    public InscripcionDAO getInscripcionDAO() {
        return new InscripcionDAOImpl(conn);
    }
}
